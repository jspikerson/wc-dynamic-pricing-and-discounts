 ...
 */
    ...
    public static function enqueue_select2()
    {
        ...
        //if (!RightPress_Help::wc_version_gte('3.2')) {
            ...
            wp_enqueue_script('rp-wcdpd-select2-scripts', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.full.min.js', array('jquery'), '4.1.0-rc.0');
            wp_enqueue_script('rp-wcdpd-select2-rp', RP_WCDPD_PLUGIN_URL . '/assets/js/rp-select2.js', array(), RP_WCDPD_VERSION);
            wp_enqueue_style('rp-wcdpd-select2-styles', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css', array(), '4.1.0-rc.0');
    ...
    public function enqueue_backend_assets()
    {
        ...
        // jQuery UI styles
        RightPress_Help::enqueue_or_inject_stylesheet('rp-wcdpd-jquery-ui-styles', RP_WCDPD_PLUGIN_URL . '/assets/jquery-ui/jquery-ui.min.css', '1.13.2');
