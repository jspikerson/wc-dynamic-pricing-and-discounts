...
abstract class RightPress_Controller_Conditions extends RightPress_Item_Controller
{
     ...
     * @return array
     */
    public static function get_cart_items_by_product_conditions($conditions = array(), $cart_items = null)
    {

        $instance = RightPress_Controller_Conditions::get_controller_instance(get_called_class(), __FUNCTION__);
        return $instance->get_cart_items_by_product_conditions_internal($conditions, $cart_items);
    }
    ...
    public function conditions_are_matched_internal($conditions, $params = array())
    {
        ...
        foreach ($conditions as $condition) {
            ...
            // Handle product conditions for WCDPD cart discount and checkout fee rules separately
            // TODO: This should be in plugin, not in library
     ...
     * @return array
     */
    public function get_cart_items_by_product_conditions_internal($conditions = array(), $cart_items = null)
    {
