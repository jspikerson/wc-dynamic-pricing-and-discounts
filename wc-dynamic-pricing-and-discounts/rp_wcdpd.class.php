...
class RP_WCDPD
{
    ...
    public function on_plugins_loaded()
    {
        ...
        require_once RP_WCDPD_PLUGIN_PATH . 'classes/conditions/conditions/rp-wcdpd-condition-product-other-cart-item-data.class.php';
        ...
        require_once RP_WCDPD_PLUGIN_PATH . 'classes/conditions/conditions/rp-wcdpd-condition-time-days-of-month.class.php';
        require_once RP_WCDPD_PLUGIN_PATH . 'classes/conditions/conditions/rp-wcdpd-condition-time-months.class.php';
        ...
        require_once RP_WCDPD_PLUGIN_PATH . 'classes/conditions/condition-fields/rp-wcdpd-condition-field-multiselect-days-of-month.class.php';
        require_once RP_WCDPD_PLUGIN_PATH . 'classes/conditions/condition-fields/rp-wcdpd-condition-field-multiselect-months.class.php';
        ...
        // Load extensions
        require_once RP_WCDPD_PLUGIN_PATH . 'extensions/promotion-cart-item-descriptions/rp-wcdpd-promotion-cart-item-descriptions.class.php';
    ...
    public static function php_version_notice()
    {
        ...
        echo '<div class="error"><p>' . sprintf(esc_html__('%1$s requires PHP %2$s or later. Please update PHP on your server to use this plugin.', 'rp_wcdpd'), '<strong>WooCommerce Dynamic Pricing & Discounts</strong>', RP_WCDPD_SUPPORT_PHP) . '</p></div>';
    }
    ...
    public static function wp_version_notice()
    {
        ...
        echo '<div class="error"><p>' . sprintf(esc_html__('%1$s requires WordPress version %2$s or later. Please update WordPress to use this plugin.', 'rp_wcdpd'), '<strong>WooCommerce Dynamic Pricing & Discounts</strong>', RP_WCDPD_SUPPORT_WP) . '</p></div>';
    }
    ...
    public static function wc_disabled_notice()
    {
        ...
        echo '<div class="error"><p>' . sprintf(esc_html__('%1$s requires WooCommerce to be active.', 'rp_wcdpd'), '<strong>WooCommerce Dynamic Pricing & Discounts</strong>') . '</p></div>';
    }
    ...
    public static function wc_version_notice()
    {
        ...
        echo '<div class="error"><p>' . sprintf(esc_html__('%1$s requires WooCommerce version %2$s or later. Please update WooCommerce to use this plugin.', 'rp_wcdpd'), '<strong>WooCommerce Dynamic Pricing & Discounts</strong>', RP_WCDPD_SUPPORT_WC) . '</p></div>';
    }
